  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Productos Destacados</h1>
          <p className="text-slate-500 dark:text-gray-400 text-sm">Selección variada de las tiendas locales de Acámbaro</p>
        </div>
      </div>
      ...
      {items.length === 0 ? (
        <div className="card p-14 text-center">
          ...
          <p className="text-slate-600 dark:text-slate-300 font-medium mb-1">Todavía no hay productos publicados</p>
